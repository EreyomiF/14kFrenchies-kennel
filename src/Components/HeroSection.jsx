          ...
          <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
            <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right text-white">
              <h1 className="text-3xl font-extrabold sm:text-5xl lg:text-6xl">
                Welcome to <br />
                <span className="text-rose-700 block text-xl sm:text-2xl lg:text-3xl">"14k Bullies & French Dogs"</span>
              </h1>

              <p className="mt-4 max-w-lg sm:text-xl/relaxed">
                Join us on a journey where every bully is a testament to our dedication, and every home welcomes an
                unparalleled companion.
              </p>
